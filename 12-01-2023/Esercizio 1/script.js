...
/*
- un metodo forEach che stampi in console.log i soli ID di ogni singolo 
elemento
 */
todos.forEach((todo) => console.log(todo.id));

/*
- un metodo map che memorizzi in una variabile tutti gli userId di ogni 
singolo elemento e quindi richiamarli con un console.log a parte
*/
const todoId = todos.map((todo) => todo.userId);
console.log(todoId);

/*
- un metodo filter che stampi in console.log i soli ID di ogni singolo 
elemento i cui valori siano maggiori o uguali a 4
*/

const todoIdLength = todos
  .filter((todo) => todo.id >= 4)
  .map((todo) => todo.id);
console.log(todoIdLength);
